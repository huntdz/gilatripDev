...
namespace Botble\CustomField\Facades { 
    ...
    class CustomFieldSupportFacade {
         ...
         * @static 
         */ 
        public static function registerRuleGroup($groupName)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::registerRuleGroup($groupName);
        }
         ...
         * @static 
         */ 
        public static function expandRuleGroup($groupName)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::expandRuleGroup($groupName);
        }
         ...
         * @static 
         */ 
        public static function registerRule($group, $title, $slug, $data)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::registerRule($group, $title, $slug, $data);
        }
         ...
         * @static 
         */ 
        public static function expandRule($group, $title, $slug, $data)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::expandRule($group, $title, $slug, $data);
        }
        ...
        {
            return \Botble\CustomField\Support\CustomFieldSupport::setRules($rules);
        }
         ...
         * @static 
         */ 
        public static function addRule($ruleName, $value = null)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::addRule($ruleName, $value);
        }
         ...
         * @static 
         */ 
        public static function exportCustomFieldsData($morphClass, $morphId)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::exportCustomFieldsData($morphClass, $morphId);
        }
         ...
         * @static 
         */ 
        public static function renderRules()
        {
            return \Botble\CustomField\Support\CustomFieldSupport::renderRules();
        }
         ...
         * @static 
         */ 
        public static function renderCustomFieldBoxes($boxes)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::renderCustomFieldBoxes($boxes);
        }
        ...
        {
            return \Botble\CustomField\Support\CustomFieldSupport::renderAssets();
        }
         ...
         * @static 
         */ 
        public static function saveCustomFields($screenName, $request, $data)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::saveCustomFields($screenName, $request, $data);
        }
         ...
         * @static 
         */ 
        public static function deleteCustomFields($screen, $data)
        {
            return \Botble\CustomField\Support\CustomFieldSupport::deleteCustomFields($screen, $data);
        }
...
namespace  { 
    ...
    class CustomField extends \Botble\CustomField\Facades\CustomFieldSupportFacade {}
